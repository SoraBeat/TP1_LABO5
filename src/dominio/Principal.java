...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Entrada entradaDeportiva = new EntradaDeportiva("Super clasico", LocalDate.of(2023, 3, 28), LocalTime.of(18, 30),
				200, 0.0, futbolNacional);
		entradaDeportiva.calcularPrecio();
		
		Entrada entradaDeportiva2 = new EntradaDeportiva("Hockey internacional!", LocalDate.of(2023, 3, 28), LocalTime.of(18, 30),
				200, 0.0, hockeyInternacional);
